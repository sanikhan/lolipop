class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :user_id, :initial_price, :selling_price, :subcategory_id, :opening_date, :closing_date, :availibility , product_attachments_attributes: [:id, :product_id, :avatar])
    end
end
